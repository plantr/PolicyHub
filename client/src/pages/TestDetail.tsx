    ...
    return (
      <div className="space-y-4" data-testid="test-detail-not-found">
        <div className="flex justify-end">
          <Button size="icon" variant="ghost" onClick={() => navigate("/frameworks")} data-testid="button-close">
            <X className="h-4 w-4" />
          </Button>
        </div>
    ...
    return (
      <div className="space-y-6" data-testid="test-create-page">
        <div className="flex flex-wrap items-start justify-between gap-4">
          ...
          <Button size="icon" variant="ghost" onClick={() => controlIdParam ? navigate(`/controls/${controlIdParam}`) : navigate("/frameworks")} data-testid="button-close">
            <X className="h-4 w-4" />
          </Button>
        </div>
