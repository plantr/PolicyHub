...
async function seed() {
  ...
  const existing = await sql`SELECT id FROM regulatory_sources WHERE short_name = 'SOC2' LIMIT 1`;
  ...
  console.log(`Deleted ${deleted.count} existing controls for SOC 2 source.`);
